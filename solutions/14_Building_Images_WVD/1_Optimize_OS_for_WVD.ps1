 ...
 # .\optimize -WindowsVersion 2004 -Verbose
  .\Windows_VDOT.ps1 -Optimizations AppxPackages, WindowsMediaPlayer, ScheduledTasks, Autologgers, Services, NetworkOptimizations, DiskCleanup -Verbose -AcceptEula
